...
export default function KalendariumScreen() {
  ...
  const STEPS: TimelineStep[] = [
    ...
    },
    {
      ...
      badge: steg2Unlocked ? 'Pågående' : 'Kommande',
    ...
    },
    {
      ...
      sub: lagUnlocked ? 'Öppet — se mitt lag' : `Tillgänglig från ${lagDateLabel}`,
    ...
    },
    {
      ...
      icon: '4',
      title: 'Mitt värdskap',
      sub: vardinfoUnlocked ? 'Öppet — se mitt värdskap' : `Pinkod skickas separat. Tillgänglig från ${vardinfoDateLabel}.`,
    ...
    },
    {
      ...
      icon: '5',
      title: 'Adress förrätt',
      sub: steg5Unlocked ? 'Öppet — se din adress' : `Tillgänglig från ${steg5DateLabel}`,
